package fatihhernn.springframework.spring5recipeapp.bootstrap;

import fatihhernn.springframework.spring5recipeapp.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Override
    @Transactional // it is solving lazy iniitialization exception
